  ...
  <div class="dashboard-container min-vh-100 p-4 p-md-5">
    <section>
      <div class="row mb-5 align-items-center">
        <div class="col-md-6">
          <h1 class="display-3 fw-light text-secondary mb-0">
            DAFTAR PEMINJAMAN
          </h1>
                ...
                <div class="row g-3">
                  ...
                  <div class="col-12">
                    ...
                    <div class="d-flex align-items-center gap-2 mb-2">
                      ...
                      <div class="qty-box">{{ selectedData?.quantity }}</div>
                    </div>
                  </div>
                  <div class="col-12">
...
// Fungsi SweetAlert untuk Konfirmasi
  ...
  try {
    ...
    window.Swal.fire({
      ...
      if (result.isConfirmed) {
        if (isApprove) routes = "/officer/borrowed_items_receive";
        else routes = "/officer/borrowed_items_rejected";
        const borrowed_id = selectedData.value.borrowed_id;
        const items_id =
          selectedData.value.item.id_facility ||
          selectedData.value.item.id_room;

        const type = selectedData.value.item.type;
